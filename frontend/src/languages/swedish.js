const swedish = {
    ...
    regen_desc: "API-hemligheten används för att skapa uppdaterings- och borttagningsvägar. Du kan återskapa API-nycklarna om du behöver det.",
    ...
    notifiers: "Aviseringsändpunkter",
    logs: "Loggar",
    help: "Hjälp",
    type: "Typ",
    edit: "Redigera",
